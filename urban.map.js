...
(function() {
  ...
  Map = (function() {
    function Map(options) {
      ...
      required = ['geoJson', 'csv', 'colors', 'countyID', 'displayVariable', 'renderTo'];
    ...
    Map.prototype.update = function(var_obj) {
      var b, binWidth, bins, c, center, color, colors, enable, fill, fmt, name, self, time, _ref, _ref1, _ref10, _ref11, _ref12, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      self = this;
      ...
      fill = function(p) {
        var _ref13, _ref14;
        return color((_ref13 = (_ref14 = self.data[p.id]) != null ? _ref14[name] : void 0) != null ? _ref13 : "#aaa");
      };
